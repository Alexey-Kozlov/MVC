...
namespace MVC
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            string EmailUserFrom = "alexeytula@gmail.com";
            string EmailUserPassword = "gjkjcfnbrA1$";
            System.Net.Mail.SmtpClient cl = new System.Net.Mail.SmtpClient("smtp.gmail.com", 587);
            cl.DeliveryMethod = System.Net.Mail.SmtpDeliveryMethod.Network;
            cl.UseDefaultCredentials = false;
            cl.Credentials = new System.Net.NetworkCredential(EmailUserFrom, EmailUserPassword);
            cl.EnableSsl = true;
            System.Net.Mail.MailMessage ms = new System.Net.Mail.MailMessage(EmailUserFrom, message.Destination);
            ms.Subject = message.Subject;
            ms.Body = message.Body;
            ms.IsBodyHtml = true;

            return cl.SendMailAsync(ms);
        }
    }
